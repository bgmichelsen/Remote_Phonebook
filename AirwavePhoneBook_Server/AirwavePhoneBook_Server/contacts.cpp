...
void Personal::set_personal_relationship(std::string PR) { personal_relationship = PR; }
std::string Personal::get_nickname() { return nickname; }
std::string Personal::get_personal_relationship() { return personal_relationship;  }
...
void Business::set_busines_relationship(std::string BR) { business_relationship = BR; }
std::string Business::get_company() { return company; }
std::string Business::get_business_relationship() { return business_relationship; }
