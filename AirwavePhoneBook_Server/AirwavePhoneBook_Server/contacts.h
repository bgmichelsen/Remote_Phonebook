...
private:
	// Private data
	std::string personal_relationship;
	std::string nickname;
...
public:
	...
	void set_personal_relationship(std::string);
	std::string get_personal_relationship();
...
private:
	// Private data
	std::string business_relationship;
	std::string company;
...
public:
	...
	void set_busines_relationship(std::string);
	std::string get_business_relationship();
